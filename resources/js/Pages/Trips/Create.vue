    ...
    <AppLayout>
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            >
                <!-- Decorative Top Bar -->
                <div
                    class="h-2 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500"
                ></div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <RichTextEditor
                                    ...
                                    placeholder="旅の思い出を自由に書いてください。太字やリストも使えます。"
                                />
                                <div
